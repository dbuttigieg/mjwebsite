...
$email_subject = "(Website) Car and Transfer Enquiry:  $name $surname";
if ($oneWayTransfer == true) {
    $email_body =
        ...
        <body>
            ...
            <p style=\"font-family: 'Droid Serif'; color: #222222\"> Details for <b> Car Rental and Transfer</b> enquiry: <br><br>
                   Name: $name <br>
                   Surname: $surname <br>
                   Email: $email_address <br>
                   Phone: $phone <br>
                   Return Transfer: No <br><br>
                   
                   <b>Car Rental Details: </b> <br>
                   Group: $group <br>
    ...
    $email_reply =
        ...
        <body>
            ...
            <h4 style='font-family: Montserrat; color: #222222'>Your Car Rental and Transfer enquiry has been received. </h4>
    ...
    $email_body =
        ...
        <body>
            <h2 style='font-family: Montserrat; color: #222222' align='center'>ENQUIRY FROM M&J CAR RENTALS WEBSITE</h2>
            <p style=\"font-family: 'Droid Serif'; color: #222222\"> 
               Details for <b> Car Rental and Transfers </b> enquiry:
               Name: $name <br>
               Surname: $surname <br>
               Email: $email_address <br>
               Phone: $phone <br>
               Return Transfer: Yes <br><br>
